...
# Carrega os dados
LOAD DATA LOCAL INFILE 'D:/DSA/SQL/3-Scripts-Cap07/EstudoCaso1/covid_mortes.csv' INTO TABLE `cap07`.`covid_mortes` CHARACTER SET UTF8 
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'D:/DSA/SQL/3-Scripts-Cap07/EstudoCaso1/covid_vacinacao.csv' INTO TABLE `cap07`.`covid_vacinacao` CHARACTER SET UTF8 
FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
